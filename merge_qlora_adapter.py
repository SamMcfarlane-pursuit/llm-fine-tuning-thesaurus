"""
Script to merge QLoRA adapter weights with the base model

This script merges the QLoRA adapter weights with the base model to create
...
def parse_args():
    parser = argparse.ArgumentParser(description="Merge QLoRA adapter with base model")
    parser.add_argument(
        "--adapter_path",
        type=str,
        default="./thesaurus-model-qlora",
        help="Path to the QLoRA adapter"
    )
    parser.add_argument(
        "--output_path",
        type=str,
